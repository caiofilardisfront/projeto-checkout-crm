<?php
// Captura a Chave Pública do .env
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                ...
                <div class="checkout-card" id="passo2_pagamento" style="display: none;" data-public-key="<?= htmlspecialchars($mpPublicKey) ?>">
            ...
            <div class="col-lg-5">
                <div class="checkout-card h-100">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        ...
                        <strong style="color: var(--tiffany-blue); font-size: 1.5rem;">R$ 2.100,00</strong>
                    </div>
                </div>
            </div>
        </div>
